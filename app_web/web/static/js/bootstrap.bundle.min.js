!function (t, e) {
    ...
    function P(t, e, n, i, o) {
        if ("string" == typeof e && t) {
            n || (n = i, i = null);
            var r = I(e, n, i), s = r[0], a = r[1], l = r[2], c = j(t), u = c[l] || (c[l] = {}),
                f = N(u, a, s ? n : null);
    ...
    var G = "collapse", Z = {toggle: !0, parent: ""}, J = {toggle: "boolean", parent: "(string|element)"},
        tt = function (t) {
            function o(e, n) {
                var i;
    ...
    var At = {
        name: "arrow", enabled: !0, phase: "main", fn: function (t) {
            var e, n = t.state, i = t.name, o = n.elements.arrow, r = n.modifiersData.popperOffsets,
                s = pt(n.placement), a = Tt(s), l = [ot, it].indexOf(s) >= 0 ? "height" : "width";
            if (o && r) {
                var c = n.modifiersData[i + "#persistent"].padding, u = gt(o), f = "y" === a ? et : ot,
                    d = "y" === a ? nt : it, h = n.rects.reference[l] + n.rects.reference[a] - r[a] - n.rects.popper[l],
                    p = r[a] - n.rects.reference[a], g = Et(o),
                    m = g ? "y" === a ? g.clientHeight || 0 : g.clientWidth || 0 : 0, v = h / 2 - p / 2, _ = c[f],
                    b = m - u[l] - c[d], y = m / 2 - u[l] / 2 + v, w = kt(_, y, b), E = a;
    ...
    var xt = {
        ...
        name: "eventListeners", enabled: !0, phase: "write", fn: function () {
            ...
            var e = t.state, n = t.instance, i = t.options, o = i.scroll, r = void 0 === o || o, s = i.resize,
                a = void 0 === s || s, l = ut(e.elements.popper),
    ...
    function Kt(t, e) {
        ...
        var n = function t(e) {
            ...
            }(t), i = "body" === ct(n), o = ut(n), r = i ? [o].concat(o.visualViewport || [], Wt(n) ? n : []) : n,
            s = e.concat(r);
    ...
    function Ut(t, e) {
        return "viewport" === e ? Qt(function (t) {
            ...
            var e = bt(t), n = Ht(t), i = t.ownerDocument.body,
                ...
                s = -n.scrollLeft + Rt(t), a = -n.scrollTop;
    ...
    function Yt(t) {
        var e, n = t.reference, i = t.element, o = t.placement, r = o ? pt(o) : null, s = o ? Ft(o) : null,
    ...
    function qt(t, e) {
        ...
        var n = e, i = n.placement, o = void 0 === i ? t.placement : i, r = n.boundary,
            ...
            h = n.padding, p = void 0 === h ? 0 : h, g = Ot("number" != typeof p ? p : Lt(p, rt)),
            ...
            E = Yt({reference: w, element: _, strategy: "absolute", placement: o}),
            T = Qt(Object.assign(Object.assign({}, _), E)), k = "popper" === u ? T : w, O = {
                ...
                for (var o = n.mainAxis, r = void 0 === o || o, s = n.altAxis, a = void 0 === s || s, l = n.fallbackPlacements, c = n.padding, u = n.boundary, f = n.rootBoundary, d = n.altBoundary, h = n.flipVariations, p = void 0 === h || h, g = n.allowedAutoPlacements, m = e.options.placement, v = pt(m), _ = l || (v !== m && p ? function (t) {
                    ...
                    return t.concat("auto" === pt(n) ? function (t, e) {
                        ...
                        var n = e, i = n.placement, o = n.boundary, r = n.rootBoundary, s = n.padding,
                            a = n.flipVariations, l = n.allowedAutoPlacements, c = void 0 === l ? at : l, u = Ft(i),
                    ...
                    var L = b[O], A = pt(L), C = "start" === Ft(L), D = [et, nt].indexOf(A) >= 0,
                        x = D ? "width" : "height",
                        S = qt(e, {placement: L, boundary: u, rootBoundary: f, altBoundary: d, padding: c}),
                        j = D ? C ? it : ot : C ? nt : et;
                    y[x] > w[x] && (j = It(j));
                    var N = It(j), I = [];
    ...
    var $t = {
        name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (t) {
            var e = t.state, n = t.name, i = e.rects.reference, o = e.rects.popper, r = e.modifiersData.preventOverflow,
                s = qt(e, {elementContext: "reference"}), a = qt(e, {altBoundary: !0}), l = Vt(s, i), c = Vt(a, o, r),
                u = Xt(l), f = Xt(c);
            e.modifiersData[n] = {
        ...
        name: "preventOverflow", enabled: !0, phase: "main", fn: function (t) {
            var e = t.state, n = t.options, i = t.name, o = n.mainAxis, r = void 0 === o || o, s = n.altAxis,
                ...
                m = qt(e, {boundary: l, rootBoundary: c, padding: f, altBoundary: u}), v = pt(e.placement),
                _ = Ft(e.placement), b = !_, y = Tt(v), w = "x" === y ? "y" : "x", E = e.modifiersData.popperOffsets,
                T = e.rects.reference, k = e.rects.popper,
                O = "function" == typeof g ? g(Object.assign(Object.assign({}, e.rects), {}, {placement: e.placement})) : g,
                L = {x: 0, y: 0};
            if (E) {
                if (r) {
                    var A = "y" === y ? et : ot, C = "y" === y ? nt : it, D = "y" === y ? "height" : "width", x = E[y],
                        S = E[y] + m[A], j = E[y] - m[C], N = h ? -k[D] / 2 : 0, I = "start" === _ ? T[D] : k[D],
                        P = "start" === _ ? -k[D] : -T[D], M = e.elements.arrow,
                        B = h && M ? gt(M) : {width: 0, height: 0},
                        ...
                        V = E[y] + U - q, X = kt(h ? Math.min(S, z) : S, x, h ? Math.max(j, V) : j);
                    E[y] = X, L[y] = X - x
                }
                if (a) {
    ...
    var oe = ie(), re = ie({defaultModifiers: [jt, Zt, xt, ht]}),
        se = ie({defaultModifiers: [jt, Zt, xt, ht, Gt, zt, Jt, At, $t]}), ae = Object.freeze({
            __proto__: null,
            popperGenerator: ie,
            detectOverflow: qt,
            createPopperBase: oe,
            ...
            popperOffsets: Zt,
            preventOverflow: Jt
        }), le = "dropdown", ce = new RegExp("ArrowUp|ArrowDown|Escape"), ue = y ? "top-end" : "top-start",
        fe = y ? "top-start" : "top-end", de = y ? "bottom-end" : "bottom-start",
        he = y ? "bottom-start" : "bottom-end", pe = y ? "left-start" : "right-start",
        ge = y ? "right-start" : "left-start", me = {
            offset: 0,
            flip: !0,
    ...
    var be = {backdrop: !0, keyboard: !0, focus: !0},
        ye = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean"}, we = function (t) {
            function o(e, n) {
                var i;
    ...
    var Le = "tooltip", Ae = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        Ce = new Set(["sanitize", "allowList", "sanitizeFn"]), De = {
            animation: "boolean",
            template: "string",
            ...
            allowList: "object",
            popperConfig: "(null|object)"
        }, xe = {AUTO: "auto", TOP: "top", RIGHT: y ? "left" : "right", BOTTOM: "bottom", LEFT: y ? "right" : "left"},
        Se = {
            animation: !0,
    ...
    var We = "scrollspy", Ke = {offset: 10, method: "auto", target: ""},
        Qe = {offset: "number", method: "string", target: "(string|element)"}, Ue = function (t) {
            function o(e, n) {
                var i;
    ...
    var Ye = {animation: "boolean", autohide: "boolean", delay: "number"},
        qe = {animation: !0, autohide: !0, delay: 5e3}, ze = function (t) {
            function o(e, n) {
                var i;
